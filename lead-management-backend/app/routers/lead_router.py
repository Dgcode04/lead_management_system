...
from app.schemas.lead import LeadCreate, LeadResponse, LeadBase, LeadUpdate
from app.services.lead_service import create_lead, get_all_lead_sources, get_all_lead_status, get_all_leads, get_lead_by_id, get_recent_leads_service, update_lead
...
def update_lead_route(lead_id: int, payload: LeadUpdate, db: Session = Depends(get_db)):
